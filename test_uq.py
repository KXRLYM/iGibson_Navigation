...
def main():
    print("Testing iGibson-------------------------------------------------------------------------------")
    s = Simulator(mode ="gui_interactive", use_pb_gui=False, image_height=128, image_width=128)
    scene = StadiumScene()
    ...
    ################### Attempt at extracting sensor information ##########

    s.sync()

    ## only works with a certain image size................................................
    pano_3d = s.renderer.get_equi(mode="3d", use_robot_camera=True)
    pano_seg = s.renderer.get_equi(mode="seg", use_robot_camera=True)
    pano_rgb = s.renderer.get_equi(mode="rgb", use_robot_camera=True)

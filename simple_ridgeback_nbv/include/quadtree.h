...
/**
Sources: https://github.com/spauka/SLAM/blob/master/occupancygrid/quadtree.h
**/
...
struct Node{
    int x,y;
    int w,h;
    int lvl; // How many levels below the root node starting from zero
